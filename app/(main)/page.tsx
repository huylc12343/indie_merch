    ...
    <div className="w-full">
      <div className="max-w-[1440px] mx-auto px-4 md:px-8 xl:px-20 py-10 xl:py-15">
        <div className="flex-col  ">
          <div className="flex flex-col xl:flex-row w-full gap-10 md:gap-5">
            {/* LEFT */}
            <div className="w-full md:max-w-[630px] xl:sticky xl:top-[174px] self-start">
              <div className="flex flex-col justify-start">
                <h1 className="font-retroguard text-5xl md:text-7xl xl:text-8xl leading-[0.8]">
                  MERCHANDISE
                </h1>

                <p className="mt-8 text-lg md:text-2xl  leading-7">
                  Bộ Merch nhỏ được In-đỉ In-đi tự tay thiết kế, mang theo chút
                  bản sắc độc lập gửi đến những tâm hồn đồng điệu. Mong bạn sẽ
                  tìm thấy một món đồ nhỏ vừa vặn với cá tính của riêng mình
                </p>
              </div>
            </div>
